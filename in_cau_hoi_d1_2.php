...
<head>
    ...
    <link rel="stylesheet" href="./assets/css_v2/InCauHoi_d1_php.css">
...
<form action="" method="post" id="form_ban_dau">
    <div id="boc_tong" class="kiemtra">
        ...
        <div class="button-container" style="text-align: center;">
            ...
            <button type="button" class="btn hinhthucTL hidden" id="traloidien" onclick="showDien()"><img src="./icon/thedapan.png" style="width:30px; height:30px; margin-right: 10px">Trả lời bằng cách điền</button>
        </div>
        <div style="display: flex;">
            <div class="contain"style="display: flex; flex-direction: column;justify-content: center;align-items: center;align-content: center;">
                <div id="container">
                    <img class="arrow_2" src="uploads/arrow.png" id="arrow" alt="arrow">
                    <div style="display: flex; margin-top: 100px;">
                        <div class="basket" id="basket"></div>
                        <div class="plate" id="plate"></div>
                        <div class="basket_plate" id="basket_plate" style="margin: 0 !important; position: relative; top: 0; left: 0; height: fit-content; width: fit-content;"></div>
                    </div>
                </div>
                <!-- em sửa lại ô button -->
                <div class="box-phepTinh" style="margin-top: 50px;">
                                <div class="square" id="square1"><input type="text" class="inputt" id='inputt1' name='inputt1' placeholder="?" required value="" style="margin: 0 !important"></div>
                                <!-- <div class="square" id="square2"><input type="text" class="inputt2" id='inputt2' name='inputt2' placeholder="?" required value=""></div>
                                <div class="square" id="square3"><input type="text" class="inputt" id='inputt3' name='inputt3' placeholder="?" required value=""></div>
                                <div class="square" id="square4"><input type="text" class="inputt2" id='inputt4' name='inputt4' placeholder="=" readonly></div>
                                <div class="square" id="square5"><input type="text" class="inputt" id='inputt5' name='inputt5' placeholder="?" required value=""></div> -->
                </div>
            </div>
            ...
            <div id="contain_1">
                <div id="contain_2">
                        ...
                        <button type="button" class="btn" id="help" name='btn_hd' value="
                            16-22-1/17-23-2/18-24-3/13-19-4/14-19-4/19-25-5/                        "><img src="./icon/support.png" style="margin-right: 10px;">Hỗ trợ</button>
                </div>
            </div>
        </div>
...
<div id="notice-container">
    ...
    <div class="help-container" id="helpcontain">
        <div  id="bieuThuc"  style=" display: none; font-family: Arial, sans-serif;
                                margin: 0;
...
function daSuDung(u) {
    ...
    console.log(lesson[index].bieuThuc);
...
<script>
    ...
    for (var i = 0; i < <?php echo $_SESSION["dang_bai"][0]; ?>; i++) {    
        ...
        img.className = "";    
        img.src = "uploads/"+<?php echo "'".$_SESSION['anh']['url_doi_tuong']."'"; ?>;    
        var newWidth = 150;    
        var newHeight = 150;    
