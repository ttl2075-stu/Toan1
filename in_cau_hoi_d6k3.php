...
<body>
                ...
                <div class="contain" style="display: flex;">
                    ...
                    <div class="box-phepTinh">
                        <div class="square" id="square1"><input type="text" class="inputt" id='inputt1' name='inputt1' placeholder="?" required value="<?php
                                                                                                                                                        if (isset($_POST['inputt1']) && $_POST['inputt1'] == $mang_rong[0]) {
                                                                                                                                                            echo $_POST['inputt1'];
                                                                                                                                                        }
                                                                                                                                                        ?>"></div>
                        ...
                        <div class="square" id="square5"><input type="text" class="inputt" id='inputt5' name='inputt5' placeholder="?" required value="<?php
    ...
    <script>
        ...
        function showdochinhanh() {
            // them_lu_vet("luu_vet", 3);
            if ("<?php echo $_SESSION['dang_bai'][1] ?>" === "+") {
                text = "Trên hình, có hai đồ vật. Đồ vật thứ nhất có số lượng là" + <?php echo $_SESSION['dang_bai'][0]; ?> + "hình. Ta lấy thêm đồ vật thứ hai có số lượng là" + <?php echo $_SESSION['dang_bai'][2]; ?> + "hình. Vậy có tất cả là bao nhiêu";
                speakVietnamese(text);
            } else if ("<?php echo $_SESSION['dang_bai'][1]; ?>" === "-") {
                text = "Ở ô màu hồng phía bên trái, có " + <?php echo $_SESSION['dang_bai'][0]; ?> + " hình. Ta bỏ bớt " + <?php echo $_SESSION['dang_bai'][2]; ?> + " hình ở ô màu xanh phía bên phải. Vậy còn lại bao nhiêu hình";
                speakVietnamese(text);
            }
        }
        ...
        function docketqua() {
            // them_lu_vet("luu_vet", 7);
            text = "Phép tinh:" + <?php echo $_SESSION['dang_bai'][0]; ?> + <?php echo $_SESSION['dang_bai'][1]; ?> + <?php echo $_SESSION['dang_bai'][2]; ?> + "bằng" + <?php echo $_SESSION['dang_bai'][4]; ?>;
            speakVietnamese(text);
        }
    ...
    <script>
        function checkAnswer() {
            ...
            function check(x, y, z, o) {
                ...
                // Phát âm thanh
                var audioUrl;
                if (inputt1_value === "" || inputt3_value === "" || inputt5_value === "" || inputt2_value === "" || inputt2_value === "") {
