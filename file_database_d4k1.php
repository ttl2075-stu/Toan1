...
if (isset($_POST['hai'])) {
    ...
    $sql = "INSERT INTO `dap_an_nguoi_dung_d6k3`(`id_dap_an_nguoi_dung_d6k3`, `id_dap_an`, `dap_an`, `stt_huong_dan`, `id_bai_tap_user`,`luu_vet`)
            VALUES 
            (null, '$id_dap_an1', '$inputt1_value', '$arr2', '$id_user','$luu_vet'),
            (null, '$id_dap_an2', '$inputt2_value', '$arr2', '$id_user','$luu_vet'),
            (null, '$id_dap_an3', '$inputt3_value', '$arr2', '$id_user','$luu_vet')";     
    // // check xem bài đấy đã hoàn thành chưa
    if(check_trang_thai_hoan_thanh($id_user)==0){
        
        if(check_dap_an_d6k3($id_dap_an1,$inputt1_value)==1&&check_dap_an_d6k3($id_dap_an2,$inputt2_value)==1&&check_dap_an_d6k3($id_dap_an3,$inputt3_value)==1){
