        ...
        <div id="boc_tong" class="kiemtra">
            ...
            <div style="display: flex;">
                <div class="contain" style="display: flex;">
                    ...
                    <table>
                        <tr id="container">
                            <td style="width: 40%;"><div class="basket" id="basket"></div></td>
                            <td style="width: 20%;"></td>
                            <td style="width: 40%;"><div class="plate" id="plate"></div></td>
                        </tr>
                        <tr >
                            <td class="box-phepTinh" style="width: 40%;">
                                <div class="square" id="square1">
                                    <input type="text" class="inputt" id='inputt1' name='inputt1' placeholder="?" required
                                        value="<?php
                            ...
                            <td class="box-phepTinh" style="width: 20%;">
                    ...
                    <div class="box-phepTinh" style="display: none;" disabled>
                        <div class="square" id="square1">
                            <input type="text" class="inputt" id='inputt1' name='inputt1' placeholder="?" required
                                value="<?php
                                if ((isset($_POST['inputt1']) && $_POST['inputt1'] == $mang_rong[0]) || $_SESSION['trang_thai'][0] == 1) {
                ...
                <div id="contain_1">
                    <div id="contain_2" style="position: relative; right: 5%; ">
                        <button type="button" class="btn" id="check" name="btn_check" onclick="checkAnswer()"><img
                                src="./icon/check.png" style="width:30px; height:30px;">Kiểm
                            tra</button>
