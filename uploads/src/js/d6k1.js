...
function showDien() {
    // if(document.querySelector('.input-container-hep')) document.querySelector('.input-container-hep').style.display ='block'
    // if(lesson[quizShow].suDungTroGiupMuc > 1 ) document.querySelector('.checkA').style.display ='none'
    document.querySelectorAll('.boxQuiz input').forEach(input => {
