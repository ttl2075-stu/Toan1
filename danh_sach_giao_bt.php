        ...
        <!-- <select name="user" id="a"> -->
            ...
            if($role==3){
             ...
             {  
                $stt=1;
                echo "<table>";
                echo "<tr class='th'><td ><b>STT</b></td><td><b>Họ tên</b></td><td><b>Xem tiến độ</b></td></tr>";
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td> <a href='danh_sach_giao_bt_chi_tiet_1.php?id_khoa_hoc=$id_khoa_hoc&id_user=".$row['id_user']."' class = 'btn_tien_do'><i class='fa-solid fa-eye'></i></a></td>";
