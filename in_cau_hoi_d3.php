...
<head>
    ...
    <link rel="stylesheet" href="./assets/css_v2/InCauHoi_d3_php.css">
...
mySetKHT.forEach((u) => {
    ...
    var speakerHTML = `<button class="speaker" onclick="readButtonContent('btn-kieuhotro${u}')">
    <i class="fa-solid fa-volume-high"></i></button><i class="fa-solid fa-hand-point-right"></i>`;
    if(u!=19){
