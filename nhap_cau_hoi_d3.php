...
<body>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <!-- số thứ nhất -->
        <label for="">Số lượng ảnh hiển thị:</label>
        ...
        <!-- <input required  type='file' name='dt2' ><br><br><br> -->
    ...
    <?php
        ...
        if(isset($_POST['btn'])){
            ...
            // id câu hỏi vừa chèn
            $last_id = $id_cau_hoi;
            $sql="INSERT INTO `dap_an_d6k3`(`id_dap_an_d6k3`, `ten_dap_an`, `trang_thai`, `stt`, `id_cau_hoi`) VALUES (null,'$so1','0','1','$last_id'),(null,'$so2','0','2','$last_id')";
